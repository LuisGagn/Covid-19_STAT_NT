...
```{r, echo=FALSE, message=FALSE,  warning=FALSE, out.width="50%" , fig.pos = 'H', fig.cap='Evolución de las Tasas de letalidad e infección. Se puede apreciar como el comprotamiento de la epidema ha sido heterogéneo entre los paises de la región. \\label{f}'}
...
```{r, echo=FALSE, message=FALSE,fig.height=4,warning=FALSE,fig.pos="H", fig.cap='Evolucion del proceso vacunatorio en Uruguay. Dado el proceso de vacunación, se espera que el 100% de la población esté vacunada con ambas dosis antes del fin del 2021.\\label{f}'}
...
```{r, echo=FALSE, out.width="85%", fig.pos="H", fig.cap='Efecto de la vacunación en los infectados diarios y personas fallecidas por día. Se observa un efecto positivo en la cantidad de fallecimientos por día a causa del Covid-19 a partir de los dos meses de inició de la vacunación.\\label{f}'}
...
```{r, echo=FALSE, warning=FALSE, out.width="75%",message=FALSE, fig.pos = 'H', fig.cap='Evolución de la Tasa de Letalidad del Covid-19 en Uruguay con modelado generalizado aditivo (GAM). Se puede apreciar que el impacto de la vacunación no es tan notoria en la Tasa de Letalidad. \\label{f}'}
fig6 <- Datos_Region %>%
...
```{r, echo=FALSE, warning=FALSE, out.width="45%",message=FALSE, fig.pos = 'H', fig.cap='Diagrama de dispersión entre la Tasa de Letalidad y el Indice de personas totalmente vacunadas en Uruguay con modelado generalizado aditivo (GAM).\\label{f5}'}
