...
La aplicacion funciona utilizando los elementos mencionados arriba donde a posteriori se explicara como funciona cada uno de estos.

### ShinyDashboard

ShinyDashboard es una extension de Shiny que ayuda a crear "Dashboards" facilitando la visualizacion y presentacion de la informacion necesaria.  
...
Consigo, tenemos una barra lateral(Dashboard) donde podemos subdividir la Shiny en secciones, liberando la concentración de datos seleccionando las rayitas.  
...
GGiraph es una extension de GGplot2 donde podemos generar graficos interactivos, en esta ocacion, lo utilizamos para generar un mapamundi interactivo.  
En dicho mapa, podemos visualizar la cantidad de Muertos e Infectados de forma diaria o acumulativa y hasta que dia del año deseamos verlo.  
Todo eso es posible gracias a la utilizacion de Shiny y su Dashboard que facilita la visualizacion del Mapa.
...
DyGraph y xts se utiliza para realizar graficos donde podemos movernos sobre la linea temporal, realizar acercamientos y analisis mas comodos al poder elegir el rango temporal.

Plotly tambien fue utilizado con el mismo objetivo pero para otros tipos de graficos
