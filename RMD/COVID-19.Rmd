...
fig2 <- Datos_Primer_Contagio %>% 
  ...
  geom_line(aes(col=COUNTRY)) + theme(legend.position = "none") +
...
```{r, echo=TRUE, fig.pos = 'H', fig.cap='Evolución de los nuevos contagios y personas fallecidas en los paises de la región.\\label{f3}'}
fig3 <- Datos_Region %>% ggplot() + geom_line(aes(x=REPORT_DATE, y=PEOPLE_POSITIVE_NEW_CASES_COUNT, color = "Nuevos casos positivos")) +
