...
```{r, echo=FALSE,message=FALSE,  warning=FALSE, fig.pos = 'H', fig.cap='Evolución de los nuevos contagios y personas fallecidas en los paises de la región.\\label{f2}'}
