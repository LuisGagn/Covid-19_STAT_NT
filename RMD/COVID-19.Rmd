...
Nuestra aplicacion Shiny, está realizada de forma que sea interactiva y atractiva a la vista del usuario, aparte de ser informativa y permitir interpretar más facilmente al análisis realizado sobre el virus COVID-19.  

La aplicación utiliza:
  
* ggplot y  para la mayor parte de graficos
...
ShinyDashboard es una extension de Shiny que ayuda a crear "Dashboards" facilitando la visualizacion y presentación de la información necesaria.  
...
*GGiraph* es una extension de *GGplot2*, donde podemos generar graficos interactivos, en esta ocasión, lo utilizamos para generar un mapamundi interactivo.  
...
*DyGraph* permite realizar gráficos dinámicos para series de tiempo, en formato *xts*, en los cuáles podemos movernos sobre la línea temporal, realizar acercamientos, resaltados de puntos y elegir el rango temporal. 
